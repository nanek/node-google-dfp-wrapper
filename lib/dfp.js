...
function _makeQuery(conditions, fields) {
  ...
  var query = fields.reduce(function(_condition, field) {
...
Dfp.prototype.replaceOrderName = function(input) {
  var lineItem = _.cloneDeep(input);
...
Dfp.prototype.replaceAdUnitName = function(input) {
  var lineItem = _.cloneDeep(input);
  return this.getAdUnit({
...
Dfp.prototype.addCriteria = function(input) {
  var lineItem = _.cloneDeep(input);
...
Dfp.prototype.replaceStartDate = function(input) {
  var lineItem = _.cloneDeep(input);
  ...
  return labelStore.getAsync(query)
    .catch(function() {
      return ctx.dfpUser.executeAPIFunction(service, method, query)
        ...
        .tap(function(id) {
          return labelStore.putAsync(conditions.name, id)
            .catch(function(e) {
